...
const workoutVideo_validation_1 = require("./workoutVideo.validation");
...
router.post("/", (0, auth_1.default)("ADMIN"), (0, fileUploadHandler_1.default)(), (0, parseDataMiddleware_1.parseField)("data"), (0, validator_1.default)(workoutVideo_validation_1.zodWorkoutVideoSchema), workoutVideo_controller_1.WorkoutVideoController.createWorkoutVideo);
