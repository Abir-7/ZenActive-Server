...
router.patch("/unfriend", (0, validator_1.default)(friendlist_validation_1.zodFriendListSchema), (0, auth_1.default)("USER"), friendlist_controller_1.FriendListController.removeFriend);
...
router.patch("/remove-request", (0, validator_1.default)(friendlist_validation_1.zodFriendListSchema), (0, auth_1.default)("USER"), friendlist_controller_1.FriendListController.removeRequest);
router.patch("/block", (0, validator_1.default)(friendlist_validation_1.zodFriendListSchema), (0, auth_1.default)("USER"), friendlist_controller_1.FriendListController.addToBlock);
router.get("/with-last-message", (0, auth_1.default)("USER"), friendlist_controller_1.FriendListController.getFriendListWithLastMessage);
