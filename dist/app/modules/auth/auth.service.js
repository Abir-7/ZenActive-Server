...
const loginUser = (userData) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (
      !(yield user_model_1.User.passwordMatch(
    ...
    const accessToken = jwtHelper_1.jwtHelper.generateToken(
      jwtPayload,
      config_1.config.security.jwt.secret,
      config_1.config.security.jwt.refreshExpiresIn
    );
    const refreshToken = jwtHelper_1.jwtHelper.generateToken(
      jwtPayload,
      config_1.config.security.jwt.refreshSecret,
      config_1.config.security.jwt.refreshExpiresIn
    );
    return {
      accessToken,
...
const verifyUser = (userData) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (
      ((_a =
        user === null || user === void 0 ? void 0 : user.authentication) ===
        null || _a === void 0
        ? void 0
        : _a.oneTimeCode) !== Number(userData.code)
    ) {
      throw new AppError_1.default(
        http_status_1.default.BAD_REQUEST,
        "Code not matched."
...
const forgotPass = (userEmail) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield (0,
    sendEmail_1.sendEmail)(userEmail, "Reset Password Verification Code", `CODE: ${OTP}`);
    const updatedData = {
...
const resetPassword = (token, userData) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const { new_password, confirm_password } = userData;
    const isExistToken = yield resetToken_model_1.ResetToken.isExistToken(
      token
    );
    if (!isExistToken) {
      throw new AppError_1.default(
    ...
    if (
      !((_a =
        isUserExist === null || isUserExist === void 0
          ? void 0
          : isUserExist.authentication) === null || _a === void 0
        ? void 0
        : _a.isResetPassword)
    ) {
      throw new AppError_1.default(
    ...
    const hashPassword = yield bcryptjs_1.default.hash(
      new_password,
      Number(config_1.config.security.bcryptSaltRounds)
    );
    const updateData = {
...
const reSendOtp = (userEmail) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const OTP = (0, generateOtp_1.default)();
    const updateUser = yield user_model_1.User.findOneAndUpdate(
      { email: userEmail },
      {
        $set: {
    ...
    yield (0,
    sendEmail_1.sendEmail)(userEmail, "Verification Code", `CODE: ${OTP}`);
